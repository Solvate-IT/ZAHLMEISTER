...
export const uxMessages:Record<string,Messages>={
  de:{
    ...
    testMessageHint:"Öffne für jeden offenen Teilnehmer den vorbereiteten Entwurf im passenden Kanal. Die App versendet dabei nichts automatisch und ändert keinen Versandstatus. Bitte Entwürfe nicht abschicken, wenn du nur prüfen möchtest.",
    testPreviewDone:"Alle Entwürfe wurden durchgesehen.",
    testPreviewEmpty:"Für die offenen Teilnehmer ist kein aktivierter und erreichbarer Kanal verfügbar.",
  ...
  en:{
    ...
    testMessageHint:"Open the prepared draft for each unpaid participant in the selected channel. The app does not send anything automatically or change delivery status. Do not send drafts if you only want to review them.",
    testPreviewDone:"All drafts have been reviewed.",
    testPreviewEmpty:"No enabled and reachable channel is available for unpaid participants.",
