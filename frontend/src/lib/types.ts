...
export interface BillingInvoice { id:string; provider:string; product_id:string; tariff_version:string; period_start:string; period_end:string; gross_amount:string; currency:string; vat_rate:string; vat_scheme:string; tax_treatment:string; invoice_number:string|null; status:string; paid_at:string|null; }
