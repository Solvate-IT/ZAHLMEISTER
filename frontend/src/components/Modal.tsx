...
export function Modal({title,onClose,children,wide=false,large=false,resizable=false}:{title:string;onClose:()=>void;children:React.ReactNode;wide?:boolean;large?:boolean;resizable?:boolean}){
  ...
  if(resizable){style.resize="both";style.overflow="hidden";style.minWidth="min(680px, calc(100vw - 36px))";style.minHeight="min(460px, calc(100vh - 36px))";style.maxWidth="calc(100vw - 36px)";style.maxHeight="calc(100vh - 36px)"}
