...
export function PublicApiDocumentation(){
  const {t}=useI18n();
  const createExample=`POST /api/public/v1/collections\nContent-Type: application/json\nAuthorization: Bearer <API_KEY>\n\n{\n  "participant_list_id": "<UUID>",\n  "name": "${t("defaultCollectionName")}",\n  "amount": "45.00",\n  "currency": "EUR",\n  "communication_channel": "auto"\n}`;
  return <section className="card">
    ...
    <div className="stack">
      ...
      <div><strong>{t("publicApiCreateExample")}</strong><pre className="code" style={{whiteSpace:"pre-wrap",margin:0}}>{createExample}</pre></div>
